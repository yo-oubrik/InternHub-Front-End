...
const page = () => {
  ...
  const { checkIsUserProfile } = useUser();

  useEffect(() => checkIsUserProfile(companyId), [currentUser]);
  ...
  return (
    <div className="py-11 flex flex-col gap-8">
      ...
      <CompanyProfileStats
        ...
        acceptedApplicants={20}
        rejectedApplicants={50}
      />
      <h1 className="header !font-medium mt-7">Company Internships</h1>
      <p className="text-gray-500">Internships count : {10}</p>
